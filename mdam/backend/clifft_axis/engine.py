...
from mdam.backend.block_magic import _gf2_solve
from mdam.backend.clifft_axis.budget import DenseMemoryBudget
...
class CliftAxisNearClifford(VirtualAxisNearClifford):
    ...
    def _pauli_lincomb_inplace(self, mx, mz, pp, alpha, beta, where=""):
        ...
        if self._compiled_numerical and (mx != 0 or mz != 0):
            ...
            if not is_diaghalf:
                from mdam.backend.clifft_axis import compiled_numerical as CN
