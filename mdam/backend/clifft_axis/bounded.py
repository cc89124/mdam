...
from mdam.backend.block_magic import _support
...
class CliftAxisBoundedNearClifford(CliftAxisNearClifford):
    ...
    def _flush_tableau(self):
        ...
        if not g:
            return
        from mdam.backend.clifft_axis import compiled_frame as CF
        n = self.n
    ...
    def measure_z(self, q):
        ...
        if (self._compiled_core and not self.resource_only
            ...
            from mdam.backend.clifft_axis.compiled_core import try_compiled_measure
