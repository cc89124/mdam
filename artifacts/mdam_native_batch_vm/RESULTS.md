...
Source of truth for the implementation: `mdam/native_vm/` (see its `README.md` and the repo-root
`PROJECT_STRUCTURE.md`). It verifies against the live authoritative Python oracle (`nearclifford_backend`
+ `ttn_backend`), which is unchanged.
