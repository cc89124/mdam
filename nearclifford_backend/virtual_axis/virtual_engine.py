...
from nearclifford_backend.block_magic import _apply_pauli_local, _vec_cx, _gf2_solve
from nearclifford_backend.virtual_axis.virtual_axis import _herm
from nearclifford_backend.virtual_axis import flop_meter as _fm
...
class TableauEngine:
    ...
    def _slaved_basis(self, q):
        ...
        from nearclifford_backend.block_magic import _vec_h, _vec_s
    ...
    def measure_drop(self, P, forced=None, rng=None):
        ...
        from nearclifford_backend.virtual_axis.clifford_synth import conj_h, conj_s, conj_cx
        from nearclifford_backend.block_magic import _vec_h, _vec_s, _vec_cx
