...
from nearclifford_backend.block_magic import _apply_pauli_local, _vec_cx
from nearclifford_backend.virtual_axis.clifford_synth import conj_cx
from nearclifford_backend.virtual_axis.virtual_axis import VirtualPauliMask, _bits
